            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item {{ request()->is('buttons') ? 'active' : '' }}"
                            href="{{ url('buttons') }}">Buttons</a>
                        <a class="collapse-item {{ request()->is('cards') ? 'active' : '' }}"
                            href="{{ url('cards') }}">Cards</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item {{ request()->is('colors') ? 'active' : '' }}"
                            href="{{ url('colors') }}">Colors</a>
                        <a class="collapse-item {{ request()->is('borders') ? 'active' : '' }}"
                            href="{{ url('borders') }}">Borders</a>
                        <a class="collapse-item {{ request()->is('animations') ? 'active' : '' }}"
                            href="{{ url('animations') }}">Animations</a>
                        <a class="collapse-item {{ request()->is('other') ? 'active' : '' }}"
                            href="{{ url('other') }}">Other</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item {{ request()->is('404') ? 'active' : '' }}"
                            href="{{ url('404') }}">404 Page</a>
                        <a class="collapse-item {{ request()->is('blank') ? 'active' : '' }}"
                            href="{{ url('blank') }}">Blank Page</a>
                    </div>
                </div>
            </li>
